...
execute if predicate copper:entity/moving as @e[tag=copper.owner] run function copper:entity/aj/tick/moving
execute unless predicate copper:entity/moving as @e[tag=copper.owner] run function copper:entity/aj/tick/idle
